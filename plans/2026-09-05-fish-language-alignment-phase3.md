...
- [x] **Step 3: Implement `count` lowering in `lowering.rs`**
...
- [x] **Step 3: Implement `contains` lowering in `lowering.rs`**
...
- [x] **Step 1: Write failing tests in `parser_test.rs`**
...
- [x] **Step 3: Update `ast.rs`, `grammar.rs`, and `emitter.rs`**
...
- [x] **Step 3: Implement compound block in `grammar.rs`**
...
- [x] **Step 1: Add comprehensive Phase 3 test**

Validate combined `count`, `contains`, safe redirections, and compound statement blocks.

- [x] **Step 2: Run fmt, clippy, and full workspace tests**
